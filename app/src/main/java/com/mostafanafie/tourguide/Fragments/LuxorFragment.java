...
public class LuxorFragment extends Fragment {
    ...
    private void setupArrayList() {
        ...
        String[] names = getResources().getStringArray(R.array.luxor_names);
        String[] descriptions = getResources().getStringArray(R.array.luxor_descriptions);
        TypedArray images = getResources().obtainTypedArray(R.array.luxor_images);
