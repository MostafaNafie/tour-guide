...
public class CairoFragment extends Fragment {
    ...
    private void setupArrayList() {
        ...
        String[] names = getResources().getStringArray(R.array.cairo_names);
        String[] descriptions = getResources().getStringArray(R.array.cairo_descriptions);
        TypedArray images = getResources().obtainTypedArray(R.array.cairo_images);
